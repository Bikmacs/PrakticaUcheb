...
public final class ProductItemBinding implements ViewBinding {
  ...
  private ProductItemBinding(@NonNull MaterialCardView rootView, @NonNull TextView productName) {
  ...
  public static ProductItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ProductItemBinding((MaterialCardView) rootView, productName);
    }
